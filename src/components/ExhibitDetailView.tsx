      ...
      <div className="relative w-full h-full overflow-y-auto animate-fade-in">
        <div className="relative">
          ...
          <button
            ...
            aria-label={t('exhibit_detail_back_button')}
          >
        ...
        <div className="p-6">
          ...
          <div className="prose prose-lg prose-invert max-w-none">
            <div className="flex justify-between items-start mb-2">
              <h3 className="text-xl font-semibold">{t('exhibit_detail_description_title')}</h3>
              <button
                ...
                aria-label={isNarrating ? t('exhibit_detail_stop_button') : t('exhibit_detail_read_aloud_button')}
              >
                {isNarrating ? <SpeakerXMarkIcon className="w-5 h-5" /> : <SpeakerWaveIcon className="w-5 h-5" />}
                <span>{isNarrating ? t('exhibit_detail_stop_button') : t('exhibit_detail_read_aloud_button')}</span>
              </button>
            </div>
